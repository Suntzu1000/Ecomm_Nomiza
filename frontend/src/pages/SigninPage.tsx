    ...
    <Container className="small-container bg-gray-800 rounded-md shadow-lg p-8 mx-auto">
      ...
      <Form onSubmit={submitHandler}>
        ...
        <div className="mb-3 text-left">
             <Button className="w-[15%] py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-500 focus:outline-none" disabled={isLoading} type="submit">
               Login
             </Button>
           ...
           <div className="mb-3 text-sm text-white">
             Novo Cliente?{' '}
             <Link className="text-indigo-500 underline" to={`/signup?redirect=${redirect}`}>Crie sua conta</Link>
           </div>
      </Form>
    </Container>
  );
